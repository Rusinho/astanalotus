var slideshow = {
		...
		initSterch: function() {
			...
			//if (newXpos >= 0){
				//alert("hoho!");
			//	newXpos = parseInt($('.page').left)*-1; //firefox compatibility
			//}
			...
			$(".strechH").each(function() {
				...
				var actualImgWidth = $(this).find("img").attr("realwidth")
				var actualImgHeight = $(this).find("img").attr("realheight")
				...
				var cropY = $(this).find("img").attr("cropY")
				var cropX = $(this).find("img").attr("cropX")
				...
				if (cropX){
					...
					if (cropX == 0){
						...
						$(this).find("img").css("width", actualRatio * actualImgWidth )
						$(this).find("img").css("height", actualRatio * actualImgHeight )
						
						var yPos = (elementHeight - parseInt($(this).find("img").css("height"))) /4
						var xPos = (windowWidth - parseInt($(this).find("img").css("width"))) /2
						
						$(this).find("img").css("top", yPos )
						$(this).find("img").css("left", xPos )
						$(this).find(".inner-visible").css("width", windowWidth )
						...
						if ($(this).attr("initialXpoz")){
							
							
							$(this).css("left", parseInt($(this).attr("initialXpoz"))-1500);
							$(this).css("width", 5000);
							$(this).find(".inner-visible").css("width", 5000);
							$(this).find("img").css("left", parseInt($(this).attr("initialXpozImg")) + 1500);
							

						} else {
							$(this).attr("initialXpoz", $(this).css("left"));
							$(this).attr("initialXpozImg", $(this).find("img").css("left"));
						}
